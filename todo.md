...
**Work Items**
- [ ] path resolution을 _zoneInitialized 가드 안으로 이동 — target: corelib/src/Rtabmap.cpp:1465
- [ ] pre-retrieval forget 로직을 retrieval 이후(post-retrieval)로 이동 — target: corelib/src/Rtabmap.cpp:3015~3133
- [ ] 주석 처리된 TRANSFER 섹션을 zone-aware post-retrieval validation으로 교체 — target: corelib/src/Rtabmap.cpp:4963~5007
